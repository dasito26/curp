...
describe('curp', () => {
  ...
  function curpConNivelIncorrecto1() {
    const persona = curp.getPersona();
    persona.nombre = 'ANTONIO';
    persona.apellidoPaterno = 'SANCHEZ';
    persona.apellidoMaterno = 'ESPEJO';
    persona.genero = curp.GENERO.MASCULINO;
    persona.fechaNacimiento = '01-05-2001';
    persona.estado = curp.ESTADO.VERACRUZ;
    expect(curp.generarConNivel(persona, 11));
  }

  function curpConNivelIncorrecto2() {
    const persona = curp.getPersona();
    persona.nombre = 'ANTONIO';
    persona.apellidoPaterno = 'SANCHEZ';
    persona.apellidoMaterno = 'ESPEJO';
    ...
    persona.fechaNacimiento = '01-05-2001';
    persona.estado = curp.ESTADO.VERACRUZ;
    expect(curp.generarConNivel(persona, 0));
  }

  function curpConNivelIncorrecto3() {
    const persona = curp.getPersona();
    persona.nombre = 'ANTONIO';
    persona.apellidoPaterno = 'SANCHEZ';
    persona.apellidoMaterno = 'ESPEJO';
    ...
    persona.fechaNacimiento = '01-05-2001';
    persona.estado = curp.ESTADO.VERACRUZ;
    expect(curp.generarConNivel(persona, 'A'));
  }

  it('Deberia lanzar un error al colocar un nivel incorrecto', () => {
    expect(curpConNivelIncorrecto1).toThrow(Error);
    expect(curpConNivelIncorrecto2).toThrow(Error);
    expect(curpConNivelIncorrecto3).toThrow(Error);
  });

  it('Deberia obtener la CURP correcta de NIVEL DEFAULT nacido ANTES del 2000', () => {
    const persona = curp.getPersona();
    persona.nombre = 'RAUL';
    persona.apellidoPaterno = 'SANGABRIEL';
    persona.apellidoMaterno = 'HERNANDEZ';
    persona.genero = curp.GENERO.MASCULINO;
    persona.fechaNacimiento = '15-04-1986';
    persona.estado = curp.ESTADO.VERACRUZ;
    expect(curp.generarConNivel(persona)).toBe('SAHR860415HVZNRL01');
  });

  it('Deberia obtener la CURP correcta de NIVEL UNO nacido ANTES del 2000', () => {
    const persona = curp.getPersona();
    persona.nombre = 'RAUL';
    persona.apellidoPaterno = 'SANGABRIEL';
    persona.apellidoMaterno = 'HERNANDEZ';
    ...
    persona.fechaNacimiento = '15-04-1986';
    persona.estado = curp.ESTADO.VERACRUZ;
    expect(curp.generarConNivel(persona, 1)).toBe('SAHR860415HVZNRL01');
  });

  it('Deberia obtener la CURP correcta de NIVEL CINCO nacido ANTES del 2000', () => {
    const persona = curp.getPersona();
    persona.nombre = 'RAUL';
    persona.apellidoPaterno = 'SANGABRIEL';
    persona.apellidoMaterno = 'HERNANDEZ';
    ...
    persona.fechaNacimiento = '15-04-1986';
    persona.estado = curp.ESTADO.VERACRUZ;
    expect(curp.generarConNivel(persona, 5)).toBe('SAHR860415HVZNRL43');
  });

  it('Deberia obtener la CURP correcta de NIVEL DEFAULT nacido DESPUES del 2000', () => {
    const persona = curp.getPersona();
    persona.nombre = 'ANTONIO';
    persona.apellidoPaterno = 'SANCHEZ';
    persona.apellidoMaterno = 'ESPEJO';
    ...
    persona.fechaNacimiento = '01-05-2001';
    persona.estado = curp.ESTADO.VERACRUZ;
    expect(curp.generarConNivel(persona)).toBe('SAEA010501HVZNSNA1');
  });

  it('Deberia obtener la CURP correcta de NIVEL TRES nacido DESPUES del 2000', () => {
    const persona = curp.getPersona();
    persona.nombre = 'ANTONIO';
    persona.apellidoPaterno = 'SANCHEZ';
    persona.apellidoMaterno = 'ESPEJO';
    ...
    persona.fechaNacimiento = '01-05-2001';
    persona.estado = curp.ESTADO.VERACRUZ;
    expect(curp.generarConNivel(persona, 3)).toBe('SAEA010501HVZNSNC7');
  });

  it('Deberia obtener la CURP correcta de NIVEL DIEZ nacido DESPUES del 2000', () => {
    const persona = curp.getPersona();
    persona.nombre = 'ANTONIO';
    persona.apellidoPaterno = 'SANCHEZ';
    persona.apellidoMaterno = 'ESPEJO';
    ...
    persona.fechaNacimiento = '01-05-2001';
    persona.estado = curp.ESTADO.VERACRUZ;
    expect(curp.generarConNivel(persona, 10)).toBe('SAEA010501HVZNSNJ3');
  });
  ...
  it('Deberia obtener true al validar una CURP de primer y segundo nivel', () => {
    expect(curp.validar('OXAR970122MVZXLS09')).toBe(true);
    expect(curp.validar('OXAR970122MVZXLS17')).toBe(true);
  });
});
